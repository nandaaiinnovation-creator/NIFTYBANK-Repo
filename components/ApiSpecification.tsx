        ...
        <SectionCard title="API Specification for Backend" iconClass="fa-solid fa-code-branch">
            ...
            <div className="space-y-8">
                <div>
                    ...
                    <p className="text-sm text-gray-500">Clients will connect to the WebSocket endpoint, e.g., <code className="text-xs bg-gray-700 px-1 rounded">ws://your-domain.com/signals</code>.</p>
